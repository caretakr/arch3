...
/dev/$BOOT_PARTITION: start=2048, size=2097152, type=C12A7328-F81F-11D2-BA4B-00A0C93EC93B, uuid=C60C9D91-B0A4-8A46-972C-39E2899DBD52
...
echo $_DATA_PASSWORD | cryptsetup luksFormat /dev/$DATA_PARTITION \
    --uuid b40f6ada-01bf-4390-92e7-ab0480352120 -d -
...
arch-chroot /mnt sh -c "echo 'options cryptdevice=UUID=6A2D732A-0605-5841-A25B-FDB0805B4BE9:root:allow-discards root=/dev/mapper/vda4 rootflags=subvol=ROOT+LIVE rw i915.enable_psr=0 i915.enable_fbc=1' >> /boot/loader/entries/arch.conf"
...
arch-chroot /mnt sh -c "echo 'options cryptdevice=UUID=6A2D732A-0605-5841-A25B-FDB0805B4BE9:root:allow-discards root=/dev/mapper/vda4 rootflags=subvol=ROOT+LIVE rw i915.enable_psr=0 i915.enable_fbc=1' >> /boot/loader/entries/arch-fallback.conf"
...
arch-chroot /mnt sh -c "echo 'options cryptdevice=UUID=6A2D732A-0605-5841-A25B-FDB0805B4BE9:root:allow-discards root=/dev/mapper/vda4 rootflags=subvol=ROOT+LIVE rw i915.enable_psr=0 i915.enable_fbc=1' >> /boot/loader/entries/arch-lts.conf"
